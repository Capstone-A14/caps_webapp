...
export default function DeletePatient({ closeModal = () => {} }) {
  return (
    <div className="bg-white rounded-lg m-5 p-5 gap-1 flex flex-col max-w-[500px] place-self-center">
      ...
      <p className="my-5">
        ...
        <span className="bg-red/10 px-2 py-1 rounded-lg font-bold text-red">"Nama Pasien".</span> Yakin ingin menghapus pasien ini?
      </p>
